...
export default function PortfolioTracker() {
  ...
  const chartDataWithBenchmarks = useMemo(() => {
    if (!chartData.length || view === "overlay" || !showBenchmarks) return chartData;
        ...
        >
          ...
          >
            ...
            >
              ...
              <button
                className={`toggle-btn ${showBenchmarks ? "active" : ""}`}
                onClick={() => setShowBenchmarks((prev) => !prev)}
                disabled={view === "overlay"}
                style={{
                  opacity: view === "overlay" ? 0.35 : 1,
                  cursor: view === "overlay" ? "not-allowed" : "pointer",
                }}
              >
                Benchmarks
              </button>
